...
class HomepageController extends Controller
{
    public function index(Posts $posts ){
        ...
        $items = DonationPackage::where('target_waktu', '>=', now())->with(['galleries'])->take(4)->get();
    ...
    public function list_donation(){
        ...
        return view('user.infaqwakaf.donationlist', compact('items','donation_package','transaction','transaction_pending','transaction_success'));
    }
