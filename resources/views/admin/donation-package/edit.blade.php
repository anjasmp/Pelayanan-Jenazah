...
@section('sub-judul','Edit Donation Packages')
@section('content')
...
<div class="container" style="margin-top: 50px; margin-bottom: 50px;">
    ...
    <form action="{{ route('donation-package.update', $item->id )}}" method="POST">
        ...
        <input type="date" class="form-control" name="target_waktu" placeholder="Completion Date" value="{{ $item->target_waktu }}">
        </div>
        <div class="form-group">
            <label for="title">Target Donation</label>
        <input type="number" class="form-control" name="target_dana" placeholder="target_dana" value="{{ $item->target_dana }}">
        </div>
