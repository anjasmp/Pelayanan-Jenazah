                ...
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <div class="d-inline-flex align-items-center">
                            <h2 class="text-dark mb-1 font-weight-medium">{{ $donation_package }}</h2>
                        </div>
                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Doantion Packages</h6>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        ...
                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Transaction
                        </h6>
                    </div>
                    <div class="ml-auto mt-md-3 mt-lg-0">
